...
message = tk.Label(window, text="", bg="white", fg="black", width=30, height=2, activebackground="black",
                   font=('times', 15, ' bold '))
...
message2 = tk.Label(window, text="", fg="black", bg="white", activeforeground="black", width=30, height=2,
                    font=('times', 15, ' bold '))
